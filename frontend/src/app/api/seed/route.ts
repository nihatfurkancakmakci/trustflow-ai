  ...
  try {
    ...
    const job = await prisma.job.create({
      data: {
        ...
        scope: "Full security audit of a Soroban-based AMM contract including vulnerability scanning, gas optimization, and best-practice recommendations. Deliverables: audit report, optimized contract code, and test suite.",
        budgetRange: "5,000",
        paymentAsset: "USDC",
        timelineAmount: "14",
        timelineUnit: "Days",
        expectedRevisions: "1 Revision",
        expertise: "Expert",
        escrowType: "Milestone-Based",
        disputePref: "AI Arbitration",
        penaltyPref: "10% Late Fee",
    ...
    const job2 = await prisma.job.create({
      data: {
        ...
        scope: "Design and implement a trustless escrow smart contract on Soroban for peer-to-peer NFT trades. Includes atomic swap logic, timeout-based refunds, and integration tests.",
        budgetRange: "3,500",
        paymentAsset: "XLM",
        timelineAmount: "21",
        timelineUnit: "Days",
        expectedRevisions: "2 Revisions",
        expertise: "Intermediate",
        escrowType: "Full Escrow",
        disputePref: "Community Vote",
        penaltyPref: "5% Late Fee",
        ghostingTimelock: "5 Days",
        hostageTimelock: "10 Days",
